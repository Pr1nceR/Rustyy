...
module.exports = {
    getListOfCommandKeywords: function (client, guildId) {
        return [
            ...
            client.intlGet(guildId, 'commandSyntaxTrack'),
            ...
            client.intlGet(guildId, 'commandSyntaxLeaderboard'),
            ...
            client.intlGet(guildId, 'commandSyntaxPlantita'),
            ...
            client.intlGet(guildId, 'commandSyntaxStat'),
            ...
            client.intlGet(guildId, 'commandSyntaxTopfarmer'),
            ...
            client.intlGet('en', 'commandSyntaxTrack'),
            ...
            client.intlGet('en', 'commandSyntaxLeaderboard'),
            ...
            client.intlGet('en', 'commandSyntaxPlantita'),
            ...
            client.intlGet('en', 'commandSyntaxStat'),
            ...
            client.intlGet('en', 'commandSyntaxTopfarmer'),
